...
PACMAN_MIRRORLIST='Server = http://mirrors.aliyun.com/archlinux/$repo/os/$arch'
PACMAN_EXTRA_PKGS=''
EXPECT_TIMEOUT=60
...
arch-chroot $ROOTFS /bin/sh -c 'pacman -Syu --noconfirm && pacman -S --noconfirm openssh'
